...
/* CTA FORM ERROR HANDELING */
// document.addEventListener("DOMContentLoaded", function () {
//   document.querySelectorAll(".cta-form__input").forEach(function (input) {
//     input.addEventListener("input", function () {
//       this.className = this.className.replace(/cta-form__input--error ?/, "");
//     });
//   });
// });
...
//   request.open("post", "success.php");
//   request.onload = function () {
//     console.log(request.responseText);
//   };
//   request.send(new FormData(ctaForm));
// });
